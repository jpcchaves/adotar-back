...
public class UpdatePasswordUseCaseImpl implements UpdatePasswordUseCase {
  ...
  public UpdatePasswordUseCaseImpl(UpdatePasswordGateway updatePasswordGateway) {
    this.updatePasswordGateway = updatePasswordGateway;
  }

  @Override
  public MessageResponseDTO updatePassword(UpdatePasswordRequestDTO requestDTO) {
