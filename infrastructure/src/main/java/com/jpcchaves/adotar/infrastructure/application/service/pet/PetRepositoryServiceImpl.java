...
import com.jpcchaves.adotar.infrastructure.infra.repository.PetRepository;
import com.jpcchaves.adotar.infrastructure.infra.repository.UserSavedPetsRepository;
...
public class PetRepositoryServiceImpl implements PetRepositoryService {
  ...
  public PetRepositoryServiceImpl(
  ...
  @Override
  public boolean isPetSavedByUser(Long userId, Long petId) {
        ...
        .orElseThrow(
            () ->
                new ResourceNotFoundException(
                    "Pet não encontrado com o ID informado: " + id));
  }

  @Override
  public Page<Pet> findByAnimalTypes(
  ...
  @Override
  public Breed fetchBreed(Long breedId, Long animalTypeId) {
    return breedRepository
        .findByIdAndAnimalType_Id(breedId, animalTypeId)
        .orElseThrow(
            () -> new ResourceNotFoundException("Raça não encontrada!"));
  }

  @Override
  public List<PetCharacteristic> fetchCharacteristics(
  ...
  public AnimalType fetchAnimalType(Long animalTypeId) {
    return animalTypeRepository
        ...
        .orElseThrow(
            () -> new ResourceNotFoundException("Tipo não encontrado!"));
  }

  @Override
  public Page<Pet> fetchAllByUser(Pageable pageable, Long userId) {
  ...
  public Pet findBySerialNumber(String serialNumber) {
    return petRepository
        ...
        .orElseThrow(
            () ->
                new ResourceNotFoundException(
                    "Pet não encontrado com o número de série informado"));
  }
  ...
  @Override
  public UserSavedPets findSavedPetByPetAndUser(Long petId, Long userId) {
    return userSavedPetsRepository
        .findByPet_IdAndUser_Id(petId, userId)
        .orElseThrow(
            () ->
                new ResourceNotFoundException(
