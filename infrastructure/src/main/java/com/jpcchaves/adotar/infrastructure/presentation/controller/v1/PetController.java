...
import com.jpcchaves.adotar.infrastructure.application.dto.pet.PetMinDto;
...
public class PetController {
  ...
  public ResponseEntity<ApiResponsePaginatedDto<PetMinDto>> listAll(
      Pageable pageable) {
  ...
  @Operation(
      ...
      responses = {
          @ApiResponse(
              ...
              responseCode = "200",
              content =
              @Content(schema = @Schema(implementation = PetDto.class))),
          @ApiResponse(
              description = "Bad Request",
              responseCode = "400",
              content = @Content),
  ...
  public ResponseEntity<PetDetailsDto> getPetDetails(
  ...
  @Operation(
      ...
      description =
          "Creates a new pet by passing a JSON representation of the pet",
      responses = {
          @ApiResponse(
              description = "Created",
              responseCode = "201",
  ...
  public ResponseEntity<ApiMessageResponseDto> create(
      @Valid @RequestBody PetCreateRequestDto petDto) {
  ...
  @Operation(
      ...
      description =
          "Updates a pet by passing a pet ID and it's JSON representation",
      responses = {
          @ApiResponse(
              description = "Success",
              responseCode = "200",
  ...
  public ResponseEntity<ApiMessageResponseDto> update(
    ...
    return ResponseEntity.status(HttpStatus.OK)
        .body(petService.update(id, petUpdateRequestDto));
  }
  ...
  @GetMapping("/filter")
  @Operation(
      summary = "Gets a pet list by filtering",
      description =
          "Gets a list of all pets filtered by the given Breed and Animal Type",
      responses = {
          @ApiResponse(
              description = "Success",
              responseCode = "200",
  ...
  filterByBreedOrAnimalType(
      @RequestParam(name = "breedId", required = false) Long breedId,
      @RequestParam(name = "animalTypeId", required = false)
      Long animalTypeId,
      Pageable pageable) {
    return ResponseEntity.ok(
        petService.filterByBreedOrAnimalType(pageable, breedId, animalTypeId));
  }

  @GetMapping("/by-user")
  @Operation(
      summary = "Gets all pets by user",
  ...
  public ResponseEntity<ApiResponsePaginatedDto<PetMinDtoV2>> getAllByUser(
      Pageable pageable) {
  ...
  @GetMapping("/{id}/owner")
  @Operation(
      summary = "Gets pet owner details",
  ...
  public ResponseEntity<UserDetailsDto> getPetOwnerDetails(
      @PathVariable(name = "id") Long id) {
  ...
  @Operation(
      summary = "Gets pet by serial number",
  ...
  public ResponseEntity<PetDto> getPetBySerialNumber(
