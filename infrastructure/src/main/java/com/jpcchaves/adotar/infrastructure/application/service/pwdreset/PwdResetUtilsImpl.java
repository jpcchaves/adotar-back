...
import com.jpcchaves.adotar.infrastructure.domain.Enum.ExpirationTime;
...
import com.jpcchaves.adotar.infrastructure.infra.repository.PasswordResetTokenRepository;
...
public class PwdResetUtilsImpl implements PwdResetUtils {
  ...
  public Boolean passwordsMatch(String newPassword, String confirmNewPassword) {
