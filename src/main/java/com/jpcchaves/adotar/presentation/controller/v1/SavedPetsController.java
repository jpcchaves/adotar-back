...
public class SavedPetsController {
  ...
  @Operation(
      summary = "Adds a saved pet for the current user",
  ...
  @PostMapping("/{petId}")
  public ResponseEntity<ApiMessageResponseDto> addUserSavedPet(
      @PathVariable(name = "petId") Long petId) {
    return ResponseEntity.ok(petService.addUserSavedPet(petId));
  }

  @Operation(
      summary = "Unsave a pet",
  ...
  @DeleteMapping("/{petId}")
  public ResponseEntity<ApiMessageResponseDto> removeUserSavedPet(
      @PathVariable(name = "petId") Long petId) {
