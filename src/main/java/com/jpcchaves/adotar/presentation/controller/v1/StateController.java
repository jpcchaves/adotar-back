...
import com.jpcchaves.adotar.application.service.usecases.v1.StateService;
...
public class StateController {
    ...
    @Operation(
            summary = "Get a state",
            description = "Returns a state by passing it's name or uf as a path variable 'nameOrUf'",
            responses = {
                    @ApiResponse(
                            description = "Success",
                            responseCode = "200",
