...
public class AuthServiceImpl implements AuthService {
    ...
    public JwtAuthResponseDto loginV2(LoginDtoV2 loginDtoV2) {
        try {
            ...
            Authentication authentication = authenticationManager
                    .authenticate(authUtils.buildNewAuthentication(loginDtoV2.getEmail(), loginDtoV2.getPassword()));
    ...
    public JwtAuthResponseDto login(LoginDto loginDto) {
        try {
            User user = authUtils.fetchUserByUsernameOrEmail(loginDto.getUsernameOrEmail());

            Authentication authentication = authenticationManager
                    .authenticate(authUtils.buildNewAuthentication(loginDto.getUsernameOrEmail(), loginDto.getPassword()));
    ...
    public RegisterResponseDto register(RegisterRequestDto registerDto) {
        ...
        authUtils.checkPasswordsMatch(registerDto.getPassword(), registerDto.getConfirmPassword());
    ...
    public ApiMessageResponseDto update(
        ...
        if (authUtils.passwordsMatches(updateUserDto.getCurrentPassword(), user.getPassword())) {
    ...
    public ApiMessageResponseDto updatePassword(UpdateUserPasswordRequestDTO requestDTO) {
        authUtils.checkPasswordsMatch(requestDTO.getNewPassword(), requestDTO.getConfirmNewPassword());
        ...
        if (!authUtils.passwordsMatches(requestDTO.getCurrentPassword(), user.getPassword())) {
